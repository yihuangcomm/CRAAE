...
import logging
import os
from dataloading_out import make_datasets, make_dataloader
...
def train(folding_id, inlier_classes, ic):
    ...
    for epoch in range(cfg.TRAIN.EPOCH_COUNT):
        ...
        for y, x in data_loader:
            ...
            z_out = E(x_fake.detach()).squeeze().detach()
            ...
            Recon_loss_out = F.binary_cross_entropy(x_out, x.detach()) * 2.0
